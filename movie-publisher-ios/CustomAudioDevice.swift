...
//    fileprivate var audioTrack: AVAssetTrack
    ...
    init(video: AVAsset, videoCapturer: VideoCapturer) {
        ...
        super.init()
//        audioTrack = videoInput.tracks(withMediaType: .audio)[0]
              ...
              while assetReader.status == AVAssetReader.Status.reading {
                if let sampleBufferRef = trackOutput.copyNextSampleBuffer() {
                  if let blockBufferRef = CMSampleBufferGetDataBuffer(sampleBufferRef) {
                    ...
                    let data:[Int16] = Array(repeating: 0, count: bufferLength)
                    let samples = UnsafeMutablePointer<Int16>(mutating: data)
...
//    var arraySamples = Array<UnsafeMutablePointer<Int16>>()
//    var arrayNumOfSamples = Array<Int>()
//    var audioIndex = 0
//
//    override init() {
//        super.init()
...
//          guard let path = Bundle.main.url(forResource: "vonage-video", withExtension:"mp4") else {
//              debugPrint("no stars in the sky today")
//              return
//          }
//
...
//        ]
//
//        let trackOutput = AVAssetReaderTrackOutput(track: track!, outputSettings: audioSettings as! [String : Any])
//
//          assetReader.add(trackOutput)
//          assetReader.startReading()
//
...
//              if let blockBufferRef = CMSampleBufferGetDataBuffer(sampleBufferRef) {
//                let bufferLength = CMBlockBufferGetDataLength(blockBufferRef)
//                  var data:[Int16] = Array(repeating: 0, count: bufferLength)
//                  var samples = UnsafeMutablePointer<Int16>(mutating: data)
//                  CMBlockBufferCopyDataBytes(blockBufferRef, atOffset: 0, dataLength: bufferLength, destination: samples)
//                  var numberOfSamples = CMSampleBufferGetNumSamples(sampleBufferRef)
//
//                  print("samples", samples)
//                  arraySamples.append(samples)
//                  arrayNumOfSamples.append(numberOfSamples)
//
//
////                  deviceAudioBus!.writeCaptureData(samples, numberOfSamples: UInt32(numberOfSamples))
//                 CMSampleBufferInvalidate(sampleBufferRef)
...
//            }
//          }
////        print("array sample", arraySamples)
////        print("arrayNumOfSamples", arrayNumOfSamples)
//
//    }
//
...
//    }
//    func estimatedCaptureDelay() -> UInt16 {
//        print("recording delay", self.recordingDelay)
//        return UInt16(0)
//    }
//    func captureIsAvailable() -> Bool {
//        return true
...
//        // TODO: Replace bufferlist
//
//        // Some sample code to generate a sine wave instead of use the mic
////                var  startingFrameCount = Double(0);
////                var  j = Double(startingFrameCount);
////                var  cycleLength = Double(DefaultAudioDevice.kSampleRate) / 880.0;
////            for frame in 0...(inNumberFrames-1) {
////                    var data = (audioDevice.bufferList?.pointee.mBuffers.mData)!
////                var sample = sin (2 * M_PI * (Double(j) / cycleLength));
////                print("data", data)
////                print("frame", frame)
////
////                    (data)[frame] = (sample * 32767.0);
////                    j += 1.0;
////                    if (j > cycleLength){
////                        j -= cycleLength;
////                    }
...
////        print("write capture data", audioDevice.arraySamples)
////        var arraySamples = Array<UnsafeMutablePointer<Int16>>()
////        var arrayNumOfSamples = Array<Int>()
//
//        audioDevice.deviceAudioBus!.writeCaptureData(audioDevice.arraySamples[audioDevice.audioIndex], numberOfSamples: UInt32(audioDevice.arrayNumOfSamples[audioDevice.audioIndex]))
//        if (audioDevice.audioIndex >= audioDevice.arraySamples.count) {
//            audioDevice.audioIndex = 0
//        }
//        else {
//            audioDevice.audioIndex+=1
//        }
//
//        Thread.sleep(forTimeInterval: 0.1)
